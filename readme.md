...
- **Session duration picker on Live Session** — Start button shows the active duration (`Start · 10 min` / `Start · Free`) with a chevron that opens an inline preset row (5 / 10 / 15 / 20 min / Free)
